...
2.将[requestment.txt](/example/stm32g030c8/pikascript/requestment.txt)放在[pikaPackage.exe](../../raw/master/pikaPackageManager/pikaPackage.exe)同一文件夹下, 运行[pikaPackage.exe](../../raw/master/pikaPackageManager/pikaPackage.exe), 自动在当前目录下安装内核、预编译器与模块。
