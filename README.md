...
PikaScript is an ultra lightweight Python engine that can run on less than 4KB of RAM (such as STM32G030C8 and STM32F103C8), with zero dependencies, zero configuration, and easy to deploy and expand.
