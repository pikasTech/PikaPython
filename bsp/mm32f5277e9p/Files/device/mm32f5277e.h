...
#define LPU_BASE         (APB2_BASE + 0x0800 )
...
#define LPT_BASE         (APB2_BASE + 0xD000 )
...
/*!
 * @addtogroup LPT_Peripheral_Access_Layer LPT Peripheral Access Layer
 *  @{
 */
...
/*!
 * @addtogroup LPT_Register_Masks Register Masks
 * @{
 */
...
#define LPT_CFG_FTLEN_SHIFT                     (15)
#define LPT_CFG_FTLEN_MASK                      (0x01U << LPT_CFG_FTLEN_SHIFT)
#define LPT_CFG_FTLEN(x)                        (((uint32_t)(((uint32_t)(x)) << LPT_CFG_FTLEN_SHIFT)) & LPT_CFG_FTLEN_MASK)

#define LPT_CFG_DICSEL_SHIFT                    (8)
#define LPT_CFG_DICSEL_MASK                     (0x7U << LPT_CFG_DICSEL_SHIFT)
#define LPT_CFG_DICSEL(x)                       (((uint32_t)(((uint32_t)(x)) << LPT_CFG_DICSEL_SHIFT)) & LPT_CFG_DICSEL_MASK)

#define LPT_CFG_TRIGCFG_SHIFT                   (6)
#define LPT_CFG_TRIGCFG_MASK                    (0x3U << LPT_CFG_TRIGCFG_SHIFT)
#define LPT_CFG_TRIGCFG(x)                      (((uint32_t)(((uint32_t)(x)) << LPT_CFG_TRIGCFG_SHIFT)) & LPT_CFG_TRIGCFG_MASK)

#define LPT_CFG_TRIGSEL_SHIFT                   (5)
#define LPT_CFG_TRIGSEL_MASK                    (0x01U << LPT_CFG_TRIGSEL_SHIFT)
#define LPT_CFG_TRIGSEL(x)                      (((uint32_t)(((uint32_t)(x)) << LPT_CFG_TRIGSEL_SHIFT)) & LPT_CFG_TRIGSEL_MASK)

#define LPT_CFG_POLARITY_SHIFT                  (4)
#define LPT_CFG_POLARITY_MASK                   (0x01U << LPT_CFG_POLARITY_SHIFT)
#define LPT_CFG_POLARITY(x)                     (((uint32_t)(((uint32_t)(x)) << LPT_CFG_POLARITY_SHIFT)) & LPT_CFG_POLARITY_MASK)

#define LPT_CFG_PWM_SHIFT                       (3)
#define LPT_CFG_PWM_MASK                        (0x01U << LPT_CFG_PWM_SHIFT)
#define LPT_CFG_PWM(x)                          (((uint32_t)(((uint32_t)(x)) << LPT_CFG_PWM_SHIFT)) & LPT_CFG_PWM_MASK)

#define LPT_CFG_TMODE_SHIFT                     (1)
#define LPT_CFG_TMODE_MASK                      (0x3U << LPT_CFG_TMODE_SHIFT)
#define LPT_CFG_TMODE(x)                        (((uint32_t)(((uint32_t)(x)) << LPT_CFG_TMODE_SHIFT)) & LPT_CFG_TMODE_MASK)

#define LPT_CFG_MODE_SHIFT                      (0)
#define LPT_CFG_MODE_MASK                       (0x01U << LPT_CFG_MODE_SHIFT)
#define LPT_CFG_MODE(x)                         (((uint32_t)(((uint32_t)(x)) << LPT_CFG_MODE_SHIFT)) & LPT_CFG_MODE_MASK)

/*!
 * @brief LPT_IE Register Bit Definition
 */

#define LPT_IE_COMPIE_SHIFT                     (2)
#define LPT_IE_COMPIE_MASK                      (0x01U << LPT_IE_COMPIE_SHIFT)
#define LPT_IE_COMPIE(x)                        (((uint32_t)(((uint32_t)(x)) << LPT_IE_COMPIE_SHIFT)) & LPT_IE_COMPIE_MASK)

#define LPT_IE_TRIGIE_SHIFT                     (1)
#define LPT_IE_TRIGIE_MASK                      (0x01U << LPT_IE_TRIGIE_SHIFT)
#define LPT_IE_TRIGIE(x)                        (((uint32_t)(((uint32_t)(x)) << LPT_IE_TRIGIE_SHIFT)) & LPT_IE_TRIGIE_MASK)

#define LPT_IE_OVIE_SHIFT                       (0)
#define LPT_IE_OVIE_MASK                        (0x01U << LPT_IE_OVIE_SHIFT)
#define LPT_IE_OVIE(x)                          (((uint32_t)(((uint32_t)(x)) << LPT_IE_OVIE_SHIFT)) & LPT_IE_OVIE_MASK)

/*!
 * @brief LPT_IF Register Bit Definition
 */

#define LPT_IF_COMPIF_SHIFT                     (2)
#define LPT_IF_COMPIF_MASK                      (0x01U << LPT_IF_COMPIF_SHIFT)
#define LPT_IF_COMPIF(x)                        (((uint32_t)(((uint32_t)(x)) << LPT_IF_COMPIF_SHIFT)) & LPT_IF_COMPIF_MASK)

#define LPT_IF_TRIGIF_SHIFT                     (1)
#define LPT_IF_TRIGIF_MASK                      (0x01U << LPT_IF_TRIGIF_SHIFT)
#define LPT_IF_TRIGIF(x)                        (((uint32_t)(((uint32_t)(x)) << LPT_IF_TRIGIF_SHIFT)) & LPT_IF_TRIGIF_MASK)

#define LPT_IF_OVIF_SHIFT                       (0)
#define LPT_IF_OVIF_MASK                        (0x01U << LPT_IF_OVIF_SHIFT)
#define LPT_IF_OVIF(x)                          (((uint32_t)(((uint32_t)(x)) << LPT_IF_OVIF_SHIFT)) & LPT_IF_OVIF_MASK)

/*!
 * @brief LPT_CTRL Register Bit Definition
 */

#define LPT_CTRL_LPTEN_SHIFT                    (0)
#define LPT_CTRL_LPTEN_MASK                     (0x01U << LPT_CTRL_LPTEN_SHIFT)
#define LPT_CTRL_LPTEN(x)                       (((uint32_t)(((uint32_t)(x)) << LPT_CTRL_LPTEN_SHIFT)) & LPT_CTRL_LPTEN_MASK)

/*!
 * @brief LPT_CNT Register Bit Definition
 */

#define LPT_CNT_CNT_SHIFT                       (0)
#define LPT_CNT_CNT_MASK                        (0xFFFFU << LPT_CNT_CNT_SHIFT)
#define LPT_CNT_CNT(x)                          (((uint32_t)(((uint32_t)(x)) << LPT_CNT_CNT_SHIFT)) & LPT_CNT_CNT_MASK)

/*!
 * @brief LPT_CMP Register Bit Definition
 */

#define LPT_CMP_COMPAREREG_SHIFT                (0)
#define LPT_CMP_COMPAREREG_MASK                 (0xFFFFU << LPT_CMP_COMPAREREG_SHIFT)
#define LPT_CMP_COMPAREREG(x)                   (((uint32_t)(((uint32_t)(x)) << LPT_CMP_COMPAREREG_SHIFT)) & LPT_CMP_COMPAREREG_MASK)

/*!
 * @brief LPT_TARGET Register Bit Definition
 */

#define LPT_TARGET_TARGETREG_SHIFT              (0)
#define LPT_TARGET_TARGETREG_MASK               (0xFFFFU << LPT_TARGET_TARGETREG_SHIFT)
#define LPT_TARGET_TARGETREG(x)                 (((uint32_t)(((uint32_t)(x)) << LPT_TARGET_TARGETREG_SHIFT)) & LPT_TARGET_TARGETREG_MASK)
...
/*!
 * @}
 */ /* end of group LPT_Peripheral_Access_Layer */
...
/*!
 * @addtogroup LPU_Register_Masks Register Masks
 * @{
 */

/*!
 * @brief LPU_LPUBAUD Register Bit Definition
 */

#define LPU_LPUBAUD_BR_SHIFT                    (16)
#define LPU_LPUBAUD_BR_MASK                     (0xFFFFU << LPU_LPUBAUD_BR_SHIFT)
#define LPU_LPUBAUD_BR(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUBAUD_BR_SHIFT)) & LPU_LPUBAUD_BR_MASK)

#define LPU_LPUBAUD_BREN_SHIFT                  (8)
#define LPU_LPUBAUD_BREN_MASK                   (0x01U << LPU_LPUBAUD_BREN_SHIFT)
#define LPU_LPUBAUD_BREN(x)                     (((uint32_t)(((uint32_t)(x)) << LPU_LPUBAUD_BREN_SHIFT)) & LPU_LPUBAUD_BREN_MASK)

#define LPU_LPUBAUD_BAUD_SHIFT                  (0)
#define LPU_LPUBAUD_BAUD_MASK                   (0x7U << LPU_LPUBAUD_BAUD_SHIFT)
#define LPU_LPUBAUD_BAUD(x)                     (((uint32_t)(((uint32_t)(x)) << LPU_LPUBAUD_BAUD_SHIFT)) & LPU_LPUBAUD_BAUD_MASK)

/*!
 * @brief LPU_MODU Register Bit Definition
 */

#define LPU_MODU_MCTL_SHIFT                     (0)
#define LPU_MODU_MCTL_MASK                      (0xFFFU << LPU_MODU_MCTL_SHIFT)
#define LPU_MODU_MCTL(x)                        (((uint32_t)(((uint32_t)(x)) << LPU_MODU_MCTL_SHIFT)) & LPU_MODU_MCTL_MASK)

/*!
 * @brief LPU_LPUIF Register Bit Definition
 */

#define LPU_LPUIF_TCIF_SHIFT                    (3)
#define LPU_LPUIF_TCIF_MASK                     (0x01U << LPU_LPUIF_TCIF_SHIFT)
#define LPU_LPUIF_TCIF(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUIF_TCIF_SHIFT)) & LPU_LPUIF_TCIF_MASK)

#define LPU_LPUIF_RXNEGIF_SHIFT                 (2)
#define LPU_LPUIF_RXNEGIF_MASK                  (0x01U << LPU_LPUIF_RXNEGIF_SHIFT)
#define LPU_LPUIF_RXNEGIF(x)                    (((uint32_t)(((uint32_t)(x)) << LPU_LPUIF_RXNEGIF_SHIFT)) & LPU_LPUIF_RXNEGIF_MASK)

#define LPU_LPUIF_TXIF_SHIFT                    (1)
#define LPU_LPUIF_TXIF_MASK                     (0x01U << LPU_LPUIF_TXIF_SHIFT)
#define LPU_LPUIF_TXIF(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUIF_TXIF_SHIFT)) & LPU_LPUIF_TXIF_MASK)

#define LPU_LPUIF_RXIF_SHIFT                    (0)
#define LPU_LPUIF_RXIF_MASK                     (0x01U << LPU_LPUIF_RXIF_SHIFT)
#define LPU_LPUIF_RXIF(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUIF_RXIF_SHIFT)) & LPU_LPUIF_RXIF_MASK)

/*!
 * @brief LPU_LPUSTA Register Bit Definition
 */

#define LPU_LPUSTA_START_SHIFT                  (7)
#define LPU_LPUSTA_START_MASK                   (0x01U << LPU_LPUSTA_START_SHIFT)
#define LPU_LPUSTA_START(x)                     (((uint32_t)(((uint32_t)(x)) << LPU_LPUSTA_START_SHIFT)) & LPU_LPUSTA_START_MASK)

#define LPU_LPUSTA_PERR_SHIFT                   (6)
#define LPU_LPUSTA_PERR_MASK                    (0x01U << LPU_LPUSTA_PERR_SHIFT)
#define LPU_LPUSTA_PERR(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPUSTA_PERR_SHIFT)) & LPU_LPUSTA_PERR_MASK)

#define LPU_LPUSTA_TC_SHIFT                     (5)
#define LPU_LPUSTA_TC_MASK                      (0x01U << LPU_LPUSTA_TC_SHIFT)
#define LPU_LPUSTA_TC(x)                        (((uint32_t)(((uint32_t)(x)) << LPU_LPUSTA_TC_SHIFT)) & LPU_LPUSTA_TC_MASK)

#define LPU_LPUSTA_TXE_SHIFT                    (4)
#define LPU_LPUSTA_TXE_MASK                     (0x01U << LPU_LPUSTA_TXE_SHIFT)
#define LPU_LPUSTA_TXE(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUSTA_TXE_SHIFT)) & LPU_LPUSTA_TXE_MASK)

#define LPU_LPUSTA_RXF_SHIFT                    (3)
#define LPU_LPUSTA_RXF_MASK                     (0x01U << LPU_LPUSTA_RXF_SHIFT)
#define LPU_LPUSTA_RXF(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUSTA_RXF_SHIFT)) & LPU_LPUSTA_RXF_MASK)

#define LPU_LPUSTA_MATCH_SHIFT                  (2)
#define LPU_LPUSTA_MATCH_MASK                   (0x01U << LPU_LPUSTA_MATCH_SHIFT)
#define LPU_LPUSTA_MATCH(x)                     (((uint32_t)(((uint32_t)(x)) << LPU_LPUSTA_MATCH_SHIFT)) & LPU_LPUSTA_MATCH_MASK)

#define LPU_LPUSTA_FERR_SHIFT                   (1)
#define LPU_LPUSTA_FERR_MASK                    (0x01U << LPU_LPUSTA_FERR_SHIFT)
#define LPU_LPUSTA_FERR(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPUSTA_FERR_SHIFT)) & LPU_LPUSTA_FERR_MASK)

#define LPU_LPUSTA_RXOV_SHIFT                   (0)
#define LPU_LPUSTA_RXOV_MASK                    (0x01U << LPU_LPUSTA_RXOV_SHIFT)
#define LPU_LPUSTA_RXOV(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPUSTA_RXOV_SHIFT)) & LPU_LPUSTA_RXOV_MASK)

/*!
 * @brief LPU_LPUCON Register Bit Definition
 */

#define LPU_LPUCON_TXPOL_SHIFT                  (12)
#define LPU_LPUCON_TXPOL_MASK                   (0x01U << LPU_LPUCON_TXPOL_SHIFT)
#define LPU_LPUCON_TXPOL(x)                     (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_TXPOL_SHIFT)) & LPU_LPUCON_TXPOL_MASK)

#define LPU_LPUCON_RXPOL_SHIFT                  (11)
#define LPU_LPUCON_RXPOL_MASK                   (0x01U << LPU_LPUCON_RXPOL_SHIFT)
#define LPU_LPUCON_RXPOL(x)                     (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_RXPOL_SHIFT)) & LPU_LPUCON_RXPOL_MASK)

#define LPU_LPUCON_PAREN_SHIFT                  (10)
#define LPU_LPUCON_PAREN_MASK                   (0x01U << LPU_LPUCON_PAREN_SHIFT)
#define LPU_LPUCON_PAREN(x)                     (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_PAREN_SHIFT)) & LPU_LPUCON_PAREN_MASK)

#define LPU_LPUCON_PTYP_SHIFT                   (9)
#define LPU_LPUCON_PTYP_MASK                    (0x01U << LPU_LPUCON_PTYP_SHIFT)
#define LPU_LPUCON_PTYP(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_PTYP_SHIFT)) & LPU_LPUCON_PTYP_MASK)

#define LPU_LPUCON_SL_SHIFT                     (8)
#define LPU_LPUCON_SL_MASK                      (0x01U << LPU_LPUCON_SL_SHIFT)
#define LPU_LPUCON_SL(x)                        (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_SL_SHIFT)) & LPU_LPUCON_SL_MASK)

#define LPU_LPUCON_DL_SHIFT                     (7)
#define LPU_LPUCON_DL_MASK                      (0x01U << LPU_LPUCON_DL_SHIFT)
#define LPU_LPUCON_DL(x)                        (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_DL_SHIFT)) & LPU_LPUCON_DL_MASK)

#define LPU_LPUCON_RXEV_SHIFT                   (5)
#define LPU_LPUCON_RXEV_MASK                    (0x3U << LPU_LPUCON_RXEV_SHIFT)
#define LPU_LPUCON_RXEV(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_RXEV_SHIFT)) & LPU_LPUCON_RXEV_MASK)

#define LPU_LPUCON_ERRIE_SHIFT                  (4)
#define LPU_LPUCON_ERRIE_MASK                   (0x01U << LPU_LPUCON_ERRIE_SHIFT)
#define LPU_LPUCON_ERRIE(x)                     (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_ERRIE_SHIFT)) & LPU_LPUCON_ERRIE_MASK)

#define LPU_LPUCON_TCIE_SHIFT                   (3)
#define LPU_LPUCON_TCIE_MASK                    (0x01U << LPU_LPUCON_TCIE_SHIFT)
#define LPU_LPUCON_TCIE(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_TCIE_SHIFT)) & LPU_LPUCON_TCIE_MASK)

#define LPU_LPUCON_TXIE_SHIFT                   (2)
#define LPU_LPUCON_TXIE_MASK                    (0x01U << LPU_LPUCON_TXIE_SHIFT)
#define LPU_LPUCON_TXIE(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_TXIE_SHIFT)) & LPU_LPUCON_TXIE_MASK)

#define LPU_LPUCON_NEDET_SHIFT                  (1)
#define LPU_LPUCON_NEDET_MASK                   (0x01U << LPU_LPUCON_NEDET_SHIFT)
#define LPU_LPUCON_NEDET(x)                     (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_NEDET_SHIFT)) & LPU_LPUCON_NEDET_MASK)

#define LPU_LPUCON_RXIE_SHIFT                   (0)
#define LPU_LPUCON_RXIE_MASK                    (0x01U << LPU_LPUCON_RXIE_SHIFT)
#define LPU_LPUCON_RXIE(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPUCON_RXIE_SHIFT)) & LPU_LPUCON_RXIE_MASK)

/*!
 * @brief LPU_LPUEN Register Bit Definition
 */

#define LPU_LPUEN_DMAR_SHIFT                    (3)
#define LPU_LPUEN_DMAR_MASK                     (0x01U << LPU_LPUEN_DMAR_SHIFT)
#define LPU_LPUEN_DMAR(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUEN_DMAR_SHIFT)) & LPU_LPUEN_DMAR_MASK)

#define LPU_LPUEN_DMAT_SHIFT                    (2)
#define LPU_LPUEN_DMAT_MASK                     (0x01U << LPU_LPUEN_DMAT_SHIFT)
#define LPU_LPUEN_DMAT(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUEN_DMAT_SHIFT)) & LPU_LPUEN_DMAT_MASK)

#define LPU_LPUEN_RXEN_SHIFT                    (1)
#define LPU_LPUEN_RXEN_MASK                     (0x01U << LPU_LPUEN_RXEN_SHIFT)
#define LPU_LPUEN_RXEN(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUEN_RXEN_SHIFT)) & LPU_LPUEN_RXEN_MASK)

#define LPU_LPUEN_TXEN_SHIFT                    (0)
#define LPU_LPUEN_TXEN_MASK                     (0x01U << LPU_LPUEN_TXEN_SHIFT)
#define LPU_LPUEN_TXEN(x)                       (((uint32_t)(((uint32_t)(x)) << LPU_LPUEN_TXEN_SHIFT)) & LPU_LPUEN_TXEN_MASK)

/*!
 * @brief LPU_LPURXD Register Bit Definition
 */

#define LPU_LPURXD_DATA_SHIFT                   (0)
#define LPU_LPURXD_DATA_MASK                    (0xFFU << LPU_LPURXD_DATA_SHIFT)
#define LPU_LPURXD_DATA(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPURXD_DATA_SHIFT)) & LPU_LPURXD_DATA_MASK)

/*!
 * @brief LPU_LPUTXD Register Bit Definition
 */

#define LPU_LPUTXD_DATA_SHIFT                   (0)
#define LPU_LPUTXD_DATA_MASK                    (0xFFU << LPU_LPUTXD_DATA_SHIFT)
#define LPU_LPUTXD_DATA(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_LPUTXD_DATA_SHIFT)) & LPU_LPUTXD_DATA_MASK)

/*!
 * @brief LPU_COMPARE Register Bit Definition
 */

#define LPU_COMPARE_COMPARE_SHIFT               (0)
#define LPU_COMPARE_COMPARE_MASK                (0xFFU << LPU_COMPARE_COMPARE_SHIFT)
#define LPU_COMPARE_COMPARE(x)                  (((uint32_t)(((uint32_t)(x)) << LPU_COMPARE_COMPARE_SHIFT)) & LPU_COMPARE_COMPARE_MASK)

/*!
 * @brief LPU_WKCKE Register Bit Definition
 */

#define LPU_WKCKE_WKCKE_SHIFT                   (0)
#define LPU_WKCKE_WKCKE_MASK                    (0x01U << LPU_WKCKE_WKCKE_SHIFT)
#define LPU_WKCKE_WKCKE(x)                      (((uint32_t)(((uint32_t)(x)) << LPU_WKCKE_WKCKE_SHIFT)) & LPU_WKCKE_WKCKE_MASK)
