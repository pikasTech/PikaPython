...
我们打开pikascript文件夹，发现文件夹根目录下除了main.py，还有Device.py，PikaObj.py和PikaStdLib.py，这三个.py文件分别对应一个PikaScript类包(class package)，简称包(package)，这个.py文件本身称为包接口(package interface)。
