...
#define __def_class(__name, __public, ...)  \
    ...
    struct __##__name {                     \
        __public PLOOC_VISIBLE(__VA_ARGS__) \
    };                                      \
    struct __name {                         \
        __public PLOOC_VISIBLE(__VA_ARGS__) \
    };
...
#define __def_class(__name, __public, ...)    \
    ...
    struct __name {                           \
        __public PLOOC_INVISIBLE(__VA_ARGS__) \
    };
...
#define extern_class_obj(__type, __obj) __EXTERN_CLASS_OBJ(__type, __obj)
#endif
...
#undef with_class
#define with_class(__type, __src, ...) __with_class(__type, __src, __VA_ARGS__)
