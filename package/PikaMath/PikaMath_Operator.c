...
int PikaMath_Operator_equalFloat(PikaObj* self,
                                 pika_float num1,
                                 pika_float num2) {
    return num1 == num2;
}
...
int PikaMath_Operator_graterThanFloat(PikaObj* self,
                                      pika_float num1,
                                      pika_float num2) {
    return num1 > num2;
}
...
int PikaMath_Operator_lessThanFloat(PikaObj* self,
                                    pika_float num1,
                                    pika_float num2) {
    return num1 < num2;
}
...
pika_float PikaMath_Operator_minusFloat(PikaObj* self,
                                        pika_float num1,
                                        pika_float num2) {
    return num1 - num2;
}
...
pika_float PikaMath_Operator_plusFloat(PikaObj* self,
                                       pika_float num1,
                                       pika_float num2) {
    return num1 + num2;
}
